...
## behaviour directory
behaviour_path = os.environ['DATA_DIR_LOCAL'] + 'compiled_positions/'+f'{mouse}'+'/week'+ f'{session}'+'/'
behaviour_processed_path = os.environ['PROJECT_DIR'] + 'data/compiled_positions/'+f'{mouse}'+'/week'+ f'{session}'+'/'
## input video path to fancy camera video
input_video_path_dlc = os.environ['DATA_DIR_LOCAL'] + '411857/week2/20210823_411857_trial1-08232021103214-0000.avi'
...
beh_path = behaviour_processed_path + beh_file_name
...
proximity_vector1_last = beh_func.long_duration_events(proximity_vector1,5)
proximity_vector2_last = beh_func.long_duration_events(proximity_vector2,5)
...
## output directoy
output_video_path_dlc = os.environ['DATA_DIR_LOCAL'] + '411857/ethogram_videos/20210823_411857_trial1-08232021103214-0000.avi'
